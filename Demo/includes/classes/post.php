...
class Post {
		...
		if(mysqli_num_rows($data_query) > 0){
					...
					while($row = mysqli_fetch_array($data_query)){
						...
						if($user_logged_obj->isFriend($added_by)){
							...
							$user_details_query = mysqli_query($this->con, "SELECT last_name, first_name, profile_pic FROM users WHERE username='$added_by'");
							...
							if($interval->y >=1){
								...
								$str .= "<div class='status_post' onClick='javascript:toggle$id()'>
											...
											<div class='newsfeedPostOptions'>
												Comments($comment_check_num)&nbsp&nbsp&nbsp&nbsp;
	...
	public function getSinglePost($post_id){
		...
		$opened_query = mysqli_query($this->con, "UPDATE notification SET opened='yes' WHERE user_to = '$userLoggedIn' AND link LIKE '%=$post_id'");
