...
<head>
	<title>Welcome on Who Cares</title>
	...
	<div class="login_box">
		...
		<div id="second">	
			<form action="register.php" method="POST">	
				...
				else if(in_array("Your last name must be between 2 and 25 characters<br>", $error_array)) echo "Your last name must be between 2 and 25 characters<br>";?>
				
				<input type="submit" name="register_button" value="Register">		
				<br>
				<?php if(in_array("<span style: 'color=#14C800;'>Goahead and login!</span><br>", $error_array)) echo "<span style: 'color=#14C800;'>Goahead and login!</span><br>";?>
